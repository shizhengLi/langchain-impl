...
class ZeroShotAgent(BaseAgent):
    ...
    This agent uses zero-shot reasoning to determine which tool to use
    based on the tool descriptions. It doesn't require examples of
    tool usage and can work with just tool descriptions.
    """
    ...
    def _create_prompt_template(self) -> PromptTemplate:
        ...
        Returns:
            Prompt template for zero-shot reasoning
        """
...
Thought: {agent_scratchpad}"""
    ...
    def plan(self, input_text: str, **kwargs) -> Union[AgentAction, AgentFinish]:
        """
        Plan next action using zero-shot reasoning
    ...
    def get_agent_info(self) -> Dict[str, Any]:
        """
        Get information about the Zero Shot agent
        ...
        base_info.update({
            ...
            "reasoning_style": "Zero-shot reasoning"
        })
        return base_info